...
_role1 = "DAYZ BRILLIANCE";
_role1names = ["Welcome to the BRILLIANCE", "This is long term server!", "Map is Cherno", "Have Fun and Enjoy"];
_role2 = "ADMINS";
_role2names = ["GH0ST"];
_role3 = "SERVER MODS";
_role3names = ["Plot4Life", "SnapPro", "Vectors", "AdvancedTrading+Coins", "Supply Drops", "Admins Missions", "and more to come..."];
_role4 = "RULES";
_role4names = ["No locked vehicles in tradezones", "No base kamikaze", "No mission crash with vehicles"];
_role5 = "TeamSpeak 3";
_role5names = ["dayz-brilliance.net"];
_role6 = "RESTART";
_role6names = ["Restart Every 4 Hours"];
_role7 = "MAINTNANCE";
_role7names = ["Base maintenance is required once a week."];
_role8 = "EXTRA!";
_role8names = ["xxx"];
{
sleep 2;
